 ...
 * of the set sizes.
 */
private fun <T, S> estimateIntersectionSize(treeNode: TreeNode<S>) : Int
        where T : Comparable<T>, S : Measurable, S : Range<T> {
...
private fun run() {
    ...
    val intersectionSize = estimateIntersectionSize<Int, SetIntersection<Int>>(rootNode)
