 ...
 * of the set sizes.
 */
private fun <T, S : Comparable<S>> estimateIntersectionSize(treeNode: TreeNode<T>): Int where T : Measurable, T : Range<S> {
    ...
    val leftLower = leftNode.value.lowerBound ?: return 0
    val leftUpper = leftNode.value.upperBound ?: return 0
    val rightLower = rightNode.value.lowerBound ?: return 0
    val rightUpper = rightNode.value.upperBound ?: return 0

    if (leftUpper < rightLower || leftLower > rightUpper) {
        return 0
    }
